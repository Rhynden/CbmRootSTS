...
class CbmStsSetup : public CbmStsElement
{
  ...
  public:
    ...
    */
     ...
     ** @param fileName  Name of file with sensor parameters
     ** @value Number of modules the parameters of which were set
     **
    ...
    /** @brief Set parameters for certain modules (individual configuration)
     **
     ** @param parMap Map of module addresses and corresponding module parameters
     **/
    Int_t SetModuleParameterMap(std::map<Int_t, CbmStsDigitizeParameters*> parMap);

    /** @brief Store module parameters to file
     **
     ** @param fileName  Name of file with sensor parameters
     **/
    Int_t StoreModuleParameters(const char* fileName);
